...
import {
  generateRandomWords,
  setFourWordsService,
} from './setFourWordsService.js';

export const chooseWordService = async (roomId, token) => {
  ...
  const topics = lobbyData.settings?.topics || [];
  ...
  //sending word list to the presenter using Gemini AI (Not stable)
  // await generateRandomWords({
  //   presenterSocketId,
  //   numWords: 4,
  //   language: 'vietnamese',
  // });
  setFourWordsService(presenterSocketId, topics);
